...
<div style={{ marginBottom: 16 }}>
 ...
 const renderSoporte = () => (
  <div style={{ fontFamily: 'DM Sans, sans-serif' }}>
    ...
    <a href="https://wa.link/qogslm" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: '#25D366', color: 'white', padding: '12px 25px', borderRadius: 50, textDecoration: 'none', fontWeight: 700, fontSize: 15 }}>
